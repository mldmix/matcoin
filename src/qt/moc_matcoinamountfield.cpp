/****************************************************************************
** Meta object code from reading C++ file 'matcoinamountfield.h'
**
**
...
#error "The header file 'matcoinamountfield.h' doesn't include <QObject>."
...
void BitcoinAmountField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BitcoinAmountField::valueChanged)) {
                *result = 0;
                return;
            }
        }
