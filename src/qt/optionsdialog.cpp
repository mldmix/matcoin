    ...
    mapper(nullptr)
{
    ...
    ui->matcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->matcoinAtStartup);
    ...
    ui->matcoinAtStartup->setToolTip(ui->matcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->matcoinAtStartup->setText(ui->matcoinAtStartup->text().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->matcoinAtStartup, OptionsModel::StartAtStartup);
