...
#include <qt/matcoin.h>
#include <qt/matcoingui.h>
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. matcoin_de.qm (shortcut "de" needs to be defined in matcoin.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. matcoin_de_DE.qm (shortcut "de_DE" needs to be defined in matcoin.qrc)
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // matcoin: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    Q_INIT_RESOURCE(matcoin);
    Q_INIT_RESOURCE(matcoin_locale);
    ...
    /// 6. Determine availability of data and blocks directory and parse matcoin.conf
    ...
    // matcoin: links repeatedly have their payment requests routed to this process:
