...
#include "qt/matcoinamountfield.h"
...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 MAT"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 MAT"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MAT"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MAT"));
        ...
        labelBalance->setText(QStringLiteral("123.456 MAT"));
...
"Note:  Since the fee is calculated on a per-byte basis, a fee of \"100 satoshis per kB\" for a transaction size of 500 bytes (half of 1 kB) would ultimately yield a fee of only 50 satoshis.", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        labelCustomFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for matcoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelCustomFeeWarning->setText(QApplication::translate("SendCoinsDialog", "A too low fee might result in a never confirming transaction (read the tooltip)", Q_NULLPTR));
        ...
        optInRBF->setText(QApplication::translate("SendCoinsDialog", "Enable Replace-By-Fee", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        optInRBF->setToolTip(QApplication::translate("SendCoinsDialog", "With Replace-By-Fee (BIP-125) you can increase a transaction's fee after it is sent. Without this, a higher fee may be recommended to compensate for increased transaction delay risk.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
