...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        gridLayout_2->addWidget(peerWhitelisted, 0, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerBanScore, 8, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerConnTime, 9, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerLastSend, 10, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerLastRecv, 11, 1, 1, 1);
        ...
        gridLayout_2->addWidget(peerBytesSent, 12, 1, 1, 1);

        label_20 = new QLabel(detailWidget);
        label_20->setObjectName(QStringLiteral("label_20"));

        gridLayout_2->addWidget(label_20, 13, 0, 1, 1);
        ...
        gridLayout_2->addWidget(peerBytesRecv, 13, 1, 1, 1);

        label_26 = new QLabel(detailWidget);
        label_26->setObjectName(QStringLiteral("label_26"));

        gridLayout_2->addWidget(label_26, 14, 0, 1, 1);
        ...
        gridLayout_2->addWidget(timeoffset, 17, 1, 1, 1);
    ...
    void retranslateUi(QWidget *RPCConsole)
    {
        ...
        dataDir->setToolTip(QApplication::translate("RPCConsole", "To specify a non-default location of the data directory use the '%1' option.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        dataDir->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
        label_11->setText(QApplication::translate("RPCConsole", "Blocksdir", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        blocksDir->setToolTip(QApplication::translate("RPCConsole", "To specify a non-default location of the blocks directory use the '%1' option.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        blocksDir->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
