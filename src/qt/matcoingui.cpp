...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and matcoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a matcoin: URI or payment request"));
